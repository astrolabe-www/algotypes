...
static Output OUTPUT = Output.PRINT;
...
void mSetup() {
  ...
  OUT_SCALE = (OUTPUT == Output.PRINT) ? 2.411 : 1;
  ...
  BORDER_WIDTH_DIMENSIONS = Card.name.equals("") ? new PVector(0.0, 0.0, 0) : new PVector(2.0, 2.33333, 0);
